<!DOCTYPE html>
  <html lang="pt-br">
    <head>
      ...
      <title>GerenciaWEB - @yield('titulo')</title>
    ...
    <body>
          ...
          <div class="container-fluid">
            <a href="{{route('index')}}" class="navbar-brand ms-sm-3">
              <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-cloud-check" viewBox="0 0 16 16">
                ...
                <span class="ms-3 fs-5">GerenciaWEB</span>
            </a>
        ...
        <nav class="navbar fixed-bottom navbar-expand-md navbar-dark bg-dark">
            <div class="container-fluid">
                <span class="text-white fw-light">&copy; Jonathan Zapotosczny. Todos os direitos reservados, 2022.</span>
            </div>
        </nav>
    </body>
