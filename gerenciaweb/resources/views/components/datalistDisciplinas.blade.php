        ...
        <tbody>
            @foreach ($data[0] as $item)
                <tr>
                    ...
                    @endforeach
                    <td>
                        <a href= "{{ route('disciplinas.edit', $item['id']) }}" class="btn btn-outline-success">
                        ...
                        <a nohref style="cursor:pointer" onclick="showInfoModal('{{ $item['nome'] }}', '{{ $item['id'] }}')" class="btn btn-outline-primary">
